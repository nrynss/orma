...
### 2026-09-15 · Review answered, deployed, ledger started

Ray-56 reviewed #707 with three Must Fix items. `de84224` answers all three,
and the fork branch carries it as `66b93a6` after merging upstream `main`.
